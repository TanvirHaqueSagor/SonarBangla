...
import ict.hackathon.shonarbangla.adapter.NavDrawerListAdapter;
import ict.hackathon.shonarbangla.model.NavDrawerItem;
import ict.hackathon.shonarbangla.model.PersistData;
...
public class MainActivity extends Activity  {
	...
	private void makeSlideList() {
		...
		SharedPreferences sharedPref = getPreferences(Context.MODE_PRIVATE);
		  ...
		  key=sharedPref.getInt("login_ok", 0); 
String username=sharedPref.getString("login_username","");
		if(key!=333){
        navDrawerItems.add(new NavDrawerItem(navMenuTitles[6], navMenuIcons.getResourceId(6, -1)));
		}else{
			navDrawerItems.add(new NavDrawerItem(navMenuTitles[7], navMenuIcons.getResourceId(7, -1), true,username ));
		 }
...
Toast.makeText(con, "Query is "+query, 1000).show(); 
   ...
   fragment = new LoginFragment();
	...
	private void GoToLoginFragment() {
		...
		.setMessage(
				getResources().getString(R.string.post_login_message))
		.setIcon(
				getResources().getDrawable(
						 R.drawable.ic_login))
		.setPositiveButton(
				getResources().getString(R.string.do_login),
	...
	private void GoToLoginFragment_FromMypost() {
		// TODO Auto-generated method stub
		new AlertDialog.Builder(this)
		.setTitle(getResources().getString(R.string.ClearCookies))
		.setMessage(
				getResources().getString(R.string.my_post_login_message))
		.setIcon(
				getResources().getDrawable(
						 R.drawable.ic_login))
		.setPositiveButton(
	...
	private void showDialog() throws NotFoundException {
		new AlertDialog.Builder(this)
				.setTitle(getResources().getString(R.string.ClearCookies))
				.setMessage(
						getResources().getString(R.string.logoutMessage))
				.setIcon(
						getResources().getDrawable(
				...
				.setPositiveButton(
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								editor.remove("login_ok");
								editor.remove("login_username");
								editor.commit();  
                             Intent i=new Intent(MainActivity.this,MainActivity.class);
                           startActivity(i);
				  Toast.makeText(getApplicationContext(), getResources().getString(R.string.logoutToast), Toast.LENGTH_LONG).show();
