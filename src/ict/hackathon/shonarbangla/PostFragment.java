...
public class PostFragment  extends Fragment implements OnClickListener, OnItemSelectedListener{
	long start, stop;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		//  FRAGMENT_ID = ((RelativeLayout) v.getParent()).getId();
		 ...
		 pName = (EditText) v.findViewById(R.id.productName);
			...
			sellPost = (Button) v.findViewById(R.id.btnSellingPost);
			 imageButton=(ImageButton) v.findViewById(R.id.imageButton); 
			 
			 sellPost.setOnClickListener(this);
			...
			product = Integer.toString(productSpinner.getSelectedItemPosition());
		 	// String a=getResources().getStringArray(R.array.product_array)[3];
				 	...
				 	if (!name.equals("") && !quantity.equals("")  && !details.equals("")
							&& !price.equals("") && !phoneNumber.equals("") && imagepath!=null) {
	...
	Runnable r = new Runnable() {
		...
		public void run() {
			...
			HttpPost post = new HttpPost(
					"http://sonarbangla.hoxty.com/post_add.php");
